...
const Home = () => {
    ...
    return (
        <Background img={img}>
            ...
            {(currentWeather && forecastWeather) && <CurrentWeather currentWeather={currentWeather}/>}
            {(currentWeather && forecastWeather) && <ForecastWeather forecastWeather={forecastWeather}/>}
            {!(currentWeather && forecastWeather) &&
            <SearchBar value={searchBarValue} onChange={handleSearchBarChange} submit={handleSubmit}
